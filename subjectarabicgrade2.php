    ...
    <div class="container" style="background: url('bgimage/subject.png');background-repeat: no-repeat;background-size: 100% 100%;">
        ...
        <div class="vision ">
           ...
           <div class="scontentbox">
            ...
            <ul>
                <li><a href="Grade2/arabic/اسماء الفواكة.ppsx" target="_blank">اسماء الفواكة</a></li>
                <li><a href="Grade2/arabic/درس الحروف.pptx" target="_blank">درس الحروف</a></li>
                <li><a href="Grade2/arabic/كتابة الحروف.pdf" target="_blank">كتابة الحروف</a></li>
